...
HRESULT Lighting::InitMesh(ID3D11Device* pd3dDevice, ID3D11DeviceContext* pContext)
{
...
void Lighting::setPosition(XMFLOAT3 position)
{
	m_position = position;
}

void Lighting::update(float t, ID3D11DeviceContext* pContext)
{
...
void Lighting::draw(ID3D11DeviceContext* pContext)
{
...
void Lighting::initialise_shader(ID3D11Device* device, ID3D11DeviceContext* device_context, const wchar_t* pixel_shader_path, const wchar_t* vertex_shader_path)
{
